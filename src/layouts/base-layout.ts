...
function dashboardLayoutV2ColorWithOpacity(color?: string, opacity?: number) {
...
export class BaseLayout extends LitElement {
  ...
  _renderDashboardLayoutV2Notify(menu: DashboardLayoutMenuConfig) {
    ...
    const borderColor = dashboardLayoutV2ColorWithOpacity(
      this._dashboardLayoutV2NotifyBorderColor(menu),
      notify.border_opacity
    );
    return html`
      <div
  ...
  _renderDashboardLayoutV2Status(menu: DashboardLayoutMenuConfig) {
    ...
    const borderColor = dashboardLayoutV2ColorWithOpacity(
      this._dashboardLayoutV2StatusBorderColor(menu),
      status.border_opacity
    );
    return html`
      <div
        class="dashboard-layout-v2-menu-status"
        style=${`--dashboard-layout-v2-status-border-color: ${borderColor}`}
      >
  ...
  _dashboardLayoutV2MenuStyle(menu: DashboardLayoutMenuConfig, submenu = false) {
    ...
    return [
      ...
      style.tab_border_color ? `--dashboard-layout-v2-tab-border-color: ${dashboardLayoutV2ColorWithOpacity(style.tab_border_color, style.tab_border_opacity)}` : "",
  ...
  _dashboardLayoutV2ContentStyle(menu: DashboardLayoutMenuConfig) {
    const style = menu.style ?? {};
    return [
      style.card_border_color ? `--dashboard-layout-v2-card-border-color: ${dashboardLayoutV2ColorWithOpacity(style.card_border_color, style.card_border_opacity)}` : "",
