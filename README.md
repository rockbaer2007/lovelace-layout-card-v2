...
- icon size from `14px` to `64px`; the editor saves `menu.style.icon_size` directly as a normalized px value and applies it by forced visual scaling to menu and submenu icons
